...
router.get('/consultants/:id/pending-tasks', requireHrm8Role(['GLOBAL_ADMIN', 'REGIONAL_LICENSEE']), ConsultantManagementController.getPendingTasks);
router.get('/consultants/:id/reassignment-options', requireHrm8Role(['GLOBAL_ADMIN', 'REGIONAL_LICENSEE']), ConsultantManagementController.getReassignmentOptions);
router.post('/consultants/:id/invite', requireHrm8Role(['GLOBAL_ADMIN', 'REGIONAL_LICENSEE']), ConsultantManagementController.invite);
router.get('/consultants/:id', ConsultantManagementController.getById);
router.put('/consultants/:id/change-role', requireHrm8Role(['GLOBAL_ADMIN', 'REGIONAL_LICENSEE']), ConsultantManagementController.changeRoleWithTasks);
